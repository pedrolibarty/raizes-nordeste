...
export const listInventoryController = async (req, res) => {
  const inventories = await listInventoryService();
...
export const retrieveInventoryController = async (req, res) => {
  ...
  const foundInventory = await retrieveInventoryService(inventoryId);
...
export const retrieveInventoryByProductController = async (req, res) => {
  ...
  const foundInventory = await retrieveInventoryByProductService(productId);
...
export const listInventoryByBranchController = async (req, res) => {
  ...
  const inventories = await listInventoryByBranchService(branchId);
